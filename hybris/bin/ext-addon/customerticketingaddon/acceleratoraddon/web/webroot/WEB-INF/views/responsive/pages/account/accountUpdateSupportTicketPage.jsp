...
<div class="back-link border">
    <c:choose>
		...
		<c:when test="${'quote' eq action}">
			<a href="../support-tickets?action=quote">
        		<span class="glyphicon glyphicon-chevron-left"></span>
    		</a>
			<span class="label"><spring:theme code="text.account.productquote.updateTicket.heading" text="Update Quotation"/></span>
		</c:when>
	</c:choose>
</div>
            ...
            <div class="item-group">
                <span class="item-label">
                	 <c:choose>
						...
						<c:when test="${'quote' eq action}">
							<spring:theme code="text.account.productquote.productName.productCode" text="Product Name | Product Code" />
						</c:when>
					</c:choose>
                </span>
