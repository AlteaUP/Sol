...
public final class CustomerticketingaddonConstants extends GeneratedCustomerticketingaddonConstants
{
	...
	public static final String TEXT_SUPPORT_QUOTING_HISTORY = "text.account.productquote.history";
	public static final String TEXT_SUPPORT_QUOTING_ADDED = "text.account.productquote.confirmation.ticket.added";
	public static final String TEXT_SUPPORT_QUOTING_UPDATE = "text.account.productquote.updateSupportTicket";
	public static final String TEXT_SUPPORT_QUOTING_ADD = "text.account.productquote.addSupportTicket";
