...
public class AdvanceSearchPageController extends AbstractSearchPageController
{
	...
	private static final String STOCK_QUANTITY_ENABLED = "storefront.products.stock.quantity.enabled";
			...
			throws CMSItemNotFoundException
	{
		...
		model.addAttribute("stockQuantityEnabled", Boolean.valueOf(Config.getBoolean(STOCK_QUANTITY_ENABLED, true)));
