...
<c:choose>
	<c:when test="${not empty addressData.id}">
		<spring:url
			...
			var="actionUrl" htmlEscape="false">
			<spring:param name="unit" value="${uid}" />
...
<%-- 							items="${titleData}" selectedValue="${addressForm.titleCode}" /> --%>
<!-- 					</div> -->
					<!--                     <div class="col-xs-12 col-sm-6"> -->
					...
					<div class="col-xs-12 col-sm-6">
						<formElement:formInputBox idKey="address.line1"
							labelKey="address.streetName" path="line1" inputCSS="text"
							mandatory="true" />
					</div>
					<div class="col-xs-12 col-sm-6">
						<formElement:formInputBox idKey="address.line2"
							labelKey="address.streetNumber" path="line2"
							inputCSS="text" mandatory="false" />
					</div>
					<div class="col-xs-12 col-sm-6">
					...
					<div class="col-xs-12 col-sm-6">
						<formElement:formInputBox idKey="address.email"
							labelKey="address.email" path="email" inputCSS="text"
							mandatory="false" />
					</div>
					
					<div class="col-xs-12 col-sm-6">
						<formElement:formInputBox idKey="address.phone"
							labelKey="address.phone" path="phone" inputCSS="text"
							mandatory="false" />
					</div>
					<div class="col-xs-12 col-sm-6">
						<formElement:formInputBox idKey="address.fax"
							labelKey="address.fax" path="fax" inputCSS="text"
							mandatory="false" />
					</div>
