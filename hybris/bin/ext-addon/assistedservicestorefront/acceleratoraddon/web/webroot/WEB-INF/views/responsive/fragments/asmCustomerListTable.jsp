                    ...
                    <table class="table techne-table">
                        <thead>
                            <tr>
                                ...
                                <th><spring:theme code="text.asm.customerList.unit" /></th>
                            ...
                            <c:forEach items="${searchPageData.results}" var="customer">
                                <tr class="techne-table-xs-left">
                                    <ycommerce:testId code="orderHistoryItem_orderDetails_link">
                                        ...
                                        <td data-th="UNIT" >
                                            <c:choose>
                                                <c:when test="${not empty customer.unit.name}">
                                                    <c:out value="[${customer.unit.erpCode}] ${customer.unit.name}"/>
                                                </c:when>
                                                <c:otherwise>
                                                    <spring:theme code="text.asm.customerList.unit.empty" /> 
                                                </c:otherwise>
                                            </c:choose>
                                        </td>
