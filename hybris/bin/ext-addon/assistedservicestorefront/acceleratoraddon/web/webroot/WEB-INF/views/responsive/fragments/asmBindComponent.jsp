		...
		<div class="input-group">
			...
			<c:choose>
				<c:when test="${emulatedUser.uid ne 'anonymous'}">
					...
					data-hover='{"name":"${fn:escapeXml(emulatedUser.name)}","email":"${fn:escapeXml(emulatedUser.uid)}","erpCode":"${fn:escapeXml(emulatedUser.defaultB2BUnit.erpCode)}","unit":"${fn:escapeXml(emulatedUser.defaultB2BUnit.name)}"}' />
