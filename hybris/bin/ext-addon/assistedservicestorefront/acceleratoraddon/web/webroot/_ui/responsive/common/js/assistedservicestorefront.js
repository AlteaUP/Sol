...
function addASMHandlers() {
    ...
    $("input[name='customerName'], input[name='customerId']").hover(function() {
            ...
            if( !(item === null || item === undefined) ) {
                $(this).after( '<div id="asmHover" class="'+ disabled +'"><span class="name">' + item.name + '</span><span class="email">' + item.email + '</span><span class="unit">[' + item.erpCode + '] ' + item.unit + '</span></div>' );
            }
        }, function () {
            removeAsmHover();
        }
    ...
    if ($("input[name='customerName']").length > 0) {
        $("input[name='customerName']").autocomplete({
            ...
            select: function( event, ui ) {
                ...
                $(this).data('hover',{name:ui.item.value, email:ui.item.email, unit:ui.item.erpCode, date:ui.item.unit});
            ...
            return $( "<li></li>" )
                ...
                .append( "<a><span class='name'>" + item.value + "</span><span class='email'>" + item.email +
                    "</span><span class='unit'>[" + item.erpCode + "] " + item.unit + "</span></a>")
                .appendTo( ul );
        };
    }
