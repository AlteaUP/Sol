 ...
 */
package com.solgroup.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("solgroupcockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("solgroupcockpits.product.externalTaxes"));
