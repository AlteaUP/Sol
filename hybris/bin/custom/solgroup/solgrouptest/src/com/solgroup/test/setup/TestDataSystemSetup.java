 ...
 */
package com.solgroup.test.setup;
...
import com.solgroup.test.constants.SolgroupTestConstants;
import com.solgroup.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SolgroupTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/solgrouptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/solgrouptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/solgrouptest/import/cstickets.impex");
			...
			importImpexFile(context, "/solgrouptest/import/csquotes.impex");
		}
	}
}
