...
import com.solgroup.storefront.forms.PlaceOrderForm;
...
@Controller
@RequestMapping(value = "/checkout/multi/solgroup-summary")
public class SolGroupSummaryCheckoutStepController extends AbstractCheckoutStepController
{
	private static final Logger LOG = Logger.getLogger(SolGroupSummaryCheckoutStepController.class);
	...
	{
        final CartData cartData = b2bCheckoutFacade.getDefaultCheckoutCart();
		...
		model.addAttribute("daysOfWeek", b2bCheckoutFacade.getDaysOfWeekForReplenishmentCheckoutSummary());
...
//		}
		...
		if (!b2bCheckoutFacade.containsTaxValues())
		{
