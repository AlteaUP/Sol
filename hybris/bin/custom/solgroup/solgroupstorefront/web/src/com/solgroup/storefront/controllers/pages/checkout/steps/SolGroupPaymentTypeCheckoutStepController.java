...
import com.solgroup.storefront.forms.validation.PaymentTypeFormValidator;
...
@Controller
@RequestMapping(value = "/checkout/multi/solgroup-payment-type")
public class SolGroupPaymentTypeCheckoutStepController extends AbstractCheckoutStepController
{
	...
	@Resource(name = "solGroupPaymentTypeFormValidator")
	...
	@RequireHardLogIn
	public String choose(@ModelAttribute final PaymentTypeForm paymentTypeForm, @ModelAttribute("cgi") final String cgi,
			final BindingResult bindingResult, final Model model) throws CMSItemNotFoundException, CommerceCartModificationException
	{
	...
	protected PaymentTypeForm preparePaymentTypeForm(final CartData cartData)
	{
		...
		//		final List<EntryPropertiesPlus> entryProperies = new ArrayList<EntryPropertiesPlus>();
		//		for (final OrderEntryData orderEntryData : entries)
		//		{
		//			final EntryPropertiesPlus entryProperty = new EntryPropertiesPlus();
		//			entryProperty.setCgi(orderEntryData.getCgi());
		//			entryProperty.setCup(orderEntryData.getCup());
		//			entryProperty.setPurchaseOrderNumber(orderEntryData.getPurchaseOrderNumber());
		//			entryProperty.setDataOrdine(orderEntryData.getDataOrdine());
		//			entryProperty.setEntryCode(orderEntryData.getEntryNumber().toString());
		//			entryProperies.add(entryProperty);
		//		}
		//		paymentTypeForm.setEntryProperties(entryProperies);
