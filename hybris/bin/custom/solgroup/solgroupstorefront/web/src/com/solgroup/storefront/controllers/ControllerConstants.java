 ...
 */
package com.solgroup.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			...
			interface MultiStepCheckout // NOSONAR
			{
				...
				String AddNotePage = "pages/checkout/multi/addNotePage"; // NOSONAR
				String CheckoutSummaryPage = "pages/checkout/multi/solgroupCheckoutSummaryPage"; // NOSONAR
				...
				String ChoosePaymentTypePage = "pages/checkout/multi/choosePaymentTypePage";// NOSONAR
			...
			interface IdentityConfirmation // NOSONAR
			{
				String IdentityConfirmationPage = "pages/newAccount/passwordCreatePage"; // NOSONAR
			}

			interface Error // NOSONAR
			{
				String ErrorNotFoundPage = "pages/error/errorNotFoundPage"; // NOSONAR
				String GenericErrorPage = "pages/error/genericErrorPage"; // NOSONAR
			}
		...
		interface Fragments
		{
			...
			interface Checkout // NOSONAR
			{
                ...
                String ReadOnlyExpandedConsignmentForm = "fragments/checkout/readOnlyExpandedConsignmentForm"; // NOSONAR
			}
