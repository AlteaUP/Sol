...
<c:choose>
	...
	<c:otherwise>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/acc.personaldata.js"></script>
		...
		<script type="text/javascript" src="${commonResourcePath}/js/acc.mydocuments.js"></script>
