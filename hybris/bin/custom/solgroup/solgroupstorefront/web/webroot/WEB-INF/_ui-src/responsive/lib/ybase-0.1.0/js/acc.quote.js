ACC.quote = {
	...
	handleDiscountModal: function(options) {
		...
		$(options.actionButtonSelector).click(function(e) {
			...
			ACC.colorbox.open(title, {
				...
				onComplete: function(){
					...
					var adjustTotal = (total - quoteDiscount).toFixed(5);
					//$("#js-quote-discount-by-percentage").val(percent.toFixed(2));
					//$("#js-quote-discount-by-amount").val(quoteDiscount.toFixed(2));
					$("#js-quote-discount-by-percentage").val(percent);
					$("#js-quote-discount-by-amount").val(quoteDiscount);
		...
		function updateByPercentage()
		{
			...
			$("#js-quote-discount-by-amount").val(resetIntial(discountAmount.toFixed(5)));
			var remainTotal = total - discountAmount;
			//var remainTotal = remainTotal.toFixed(2);
			$("#js-quote-discount-adjust-total").val(resetIntial(remainTotal.toFixed(5)));
		...
		function updateNewTotal(newTotal){
			...
			var newTotal = parseFloat(newTotal).toFixed(5).replace(/(\d)(?=(\d{3})+\.)/g, '$1,'); // format num to money
