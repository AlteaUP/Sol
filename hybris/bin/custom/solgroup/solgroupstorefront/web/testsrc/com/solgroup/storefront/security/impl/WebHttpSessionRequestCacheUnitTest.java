...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/solgroupstorefront/electronics/en",
						"https://electronics.local:9002/solgroupstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/solgroupstorefront/electronics/en",
						"https://electronics.local:9002/solgroupstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/solgroupstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/solgroupstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/solgroupstorefront/electronics/en",
						"https://electronics.local:9002/solgroupstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/solgroupstorefront",
						"https://electronics.local:9002/solgroupstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/solgroupstorefront",
						"https://electronics.local:9002/solgroupstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/solgroupstorefront/electronics/en",
						"https://electronics.local:9002/solgroupstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
