...
import static com.solgroup.core.constants.SolgroupCoreConstants.QUOTE_USER_TYPE;
	...
	public Transition executeAction(final QuoteProcessModel process) throws RetryLaterException, Exception
	{
		...
		if (QuoteUserType.BUYER.equals(quoteUserType))
		{
        	...
        	sessionService.executeInLocalView(new SessionExecutionBody()
			{
				...
				{
                    return getCommerceQuoteService().createQuoteSnapshotWithState(quoteModel, QuoteState.SELLER_REQUEST);
