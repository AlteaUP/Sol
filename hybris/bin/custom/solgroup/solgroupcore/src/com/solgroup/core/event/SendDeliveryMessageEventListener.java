...
public class SendDeliveryMessageEventListener extends AbstractAcceleratorSiteEventListener<SendDeliveryMessageEvent>
{
    ...
    // creazione del business process delegata a "SolGroupConsignmentPrepareInterceptor"
	@Override
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(final SendDeliveryMessageEvent event)
	{
