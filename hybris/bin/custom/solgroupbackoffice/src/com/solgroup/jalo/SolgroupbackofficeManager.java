...
import com.solgroup.constants.SolgroupbackofficeConstants;
 ...
 */
public class SolgroupbackofficeManager extends GeneratedSolgroupbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SolgroupbackofficeManager.class.getName());
	 ...
	 */
	public static SolgroupbackofficeManager getInstance()
	{
		return (SolgroupbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SolgroupbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolgroupbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SolgroupbackofficeManager called.");
		}
	}
