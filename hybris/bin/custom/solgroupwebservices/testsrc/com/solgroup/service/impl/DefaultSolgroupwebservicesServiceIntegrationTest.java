 ...
 */
@IntegrationTest
public class DefaultSolgroupwebservicesServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	private SolgroupwebservicesService solgroupwebservicesService;
	@Resource
	...
	{
		// given
		final String logoCode = "solgroupwebservicesPlatformLogo";

		// when
		final String logoUrl = solgroupwebservicesService.getHybrisLogoUrl(logoCode);
