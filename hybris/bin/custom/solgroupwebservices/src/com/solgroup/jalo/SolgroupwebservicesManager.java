...
/**
 * This is the extension manager of the Solgroupwebservices extension.
 */
public class SolgroupwebservicesManager extends GeneratedSolgroupwebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SolgroupwebservicesManager.class);
	 ...
	 */
	public static SolgroupwebservicesManager getInstance()
	{
		return (SolgroupwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SolgroupwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SolgroupwebservicesManager() // NOPMD 
	{
		LOG.debug("constructor of SolgroupwebservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SolgroupwebservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SolgroupwebservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
