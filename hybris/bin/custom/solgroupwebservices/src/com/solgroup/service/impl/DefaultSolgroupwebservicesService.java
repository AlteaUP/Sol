...
public class DefaultSolgroupwebservicesService implements SolgroupwebservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSolgroupwebservicesService.class);
	...
	{
		return DefaultSolgroupwebservicesService.class.getResourceAsStream("/solgroupwebservices/sap-hybris-platform.png");
	}
